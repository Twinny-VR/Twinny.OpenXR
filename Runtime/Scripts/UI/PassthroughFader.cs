...
namespace Twinny.XR
{
    ...
    public class PassthroughFader : TSingleton<PassthroughFader>
    {
        ...
        /// </summary>
        public enum PassthroughViewingMode
        {
            Underlay,
            Selective
        }
        ...
        [SerializeField]
        private PassthroughViewingMode m_passthroughViewingMode = PassthroughViewingMode.Selective;
        ...
        /// </summary>
        public static void SetupPassthrough(PassthroughViewingMode passthroughMode)
        {
            Instance.m_passthroughViewingMode = passthroughMode;
            Instance.SetupPassthrough();
        }
        private void SetupPassthrough()
        {
            if (m_mainCamera != null) m_skyboxBackgroundColor = m_mainCamera.backgroundColor;
        ...
        private IEnumerator FadeToTarget()
        {
            ...
            else
            {
                ...
                if (m_passthroughViewingMode == PassthroughViewingMode.Underlay)
                {
                    m_mainCamera.clearFlags = CameraClearFlags.Skybox;
                    m_mainCamera.backgroundColor = m_skyboxBackgroundColor;
                    CallbackHub.CallAction<ITwinnyXRCallbacks>(callback => callback.OnSetPassthrough(false));
                }
